    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            ...
            $categorie->setLibelle($faker->sentence(6))
                ...
                ->setImage("https://fbdev.mpsecure.com/groupon/201301_dir/images/upload/1359358346_cat_1.jpg");
        ...
        for ($i = 0; $i < 15; $i++) {
            ...
            $produit->setLibelle($faker->sentence(6))
                ...
                ->setImagePrincipale("https://fbdev.mpsecure.com/groupon/201301_dir/images/upload/1358935324_cute-cats-cats-8477446-600-600.jpg")
                ->setImageSecondaire1("https://fbdev.mpsecure.com/groupon/201301_dir/images/upload/1358935324_cute-cats-cats-8477446-600-600.jpg")
                ->setImageSecondaire2("https://fbdev.mpsecure.com/groupon/201301_dir/images/upload/1358935324_cute-cats-cats-8477446-600-600.jpg")
